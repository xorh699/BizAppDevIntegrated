<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Coupons(lermin).aspx.cs" Inherits="BizAppDev.Coupons_lermin_" %>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this coupon?');"></asp:LinkButton>
                                ...
                                <tr>
                                    <td><asp:Button ID="btn_add" runat="server" Height="31px" OnClick="btn_add_Click" Text="Add New Coupons" Width="200px" class="btn btn-primary" style="color: white;margin-top:10px;"/></td>
                                </tr>
                                <tr>
                                    <td></td>
                                </tr>
