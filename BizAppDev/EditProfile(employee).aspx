<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="EditProfile(employee).aspx.cs" Inherits="BizAppDev.EditProfile_employee_" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    border-radius: 100%;">
                  <asp:DataList ID="DataList2" runat="server" DataKeyField="EmpID" DataSourceID="SqlDataSource1" Width="324px">
                      <ItemTemplate>
...
<br />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Project %>" SelectCommand="SELECT * FROM [Employee] WHERE ([EmpName] = @EmpName)">
                            <SelectParameters>
                                <asp:QueryStringParameter Name="EmpName" QueryStringField="AdmName" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
