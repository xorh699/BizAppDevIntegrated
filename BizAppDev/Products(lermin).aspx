          ...
          <div class="bg-white">
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                ...
                <asp:Button ID="btn_add_product" runat="server" OnClick="btn_add_product_Click" Text="Add Product" class="btn btn-secondary" style="color: white;"/>
            </div>
          </div>
          ...
          <div class="bg-white">
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                ...
                <asp:Button ID="btn_addpackage" runat="server" OnClick="btn_addpackage_Click" Text="Add Package" class="btn btn-secondary" style="color: white;"/>
            </div>
          </div>
                        <table style="width: 1309px;">
                        <tr>
