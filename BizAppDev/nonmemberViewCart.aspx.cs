...
namespace BizAppDev
{
    public partial class nonmemberViewCart : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("nonmembereditorder.aspx?id=" + GridView1.SelectedRow.Cells[1].Text);
        }
        ...
        protected void btn_checkout_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("nonmembercheckout.aspx");
